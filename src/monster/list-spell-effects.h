...
RSE(2,	0,				GF_LIGHT,	TRUE,	TMD_BLIND,		RV(2,1,5,0),	RV(0,0,0,0),	0,		FALSE,	OF_RES_BLIND,	RV(10,0,0,0))
RSE(3,	0,				GF_DARK,	TRUE,	TMD_BLIND,		RV(2,1,5,0),	RV(0,0,0,0),	0,		FALSE,	OF_RES_BLIND,	RV(10,0,0,0))
RSE(4,	0,				GF_SOUND,	TRUE,	TMD_STUN,		RV(5,0,0,0),	RV(0,1,33,35),	0,		FALSE,	OF_RES_STUN,	RV(20,0,0,0))
...
RSE(7,	0,				GF_CHAOS,	TRUE,	TMD_CONFUSED,	RV(9,1,20,0),	RV(0,0,0,0),	0,		FALSE,	OF_RES_CONFU,	RV(0,0,0,0))
RSE(8,	0,				GF_INERTIA,	TRUE,	TMD_SLOW,		RV(3,1,4,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(30,0,0,0))
RSE(9,	0,				GF_GRAVITY,	TRUE,	TMD_STUN,		RV(5,0,0,0),	RV(0,1,33,35),	0,		FALSE,	OF_RES_STUN,	RV(30,0,0,0))
RSE(10,	RSF_BRAIN_SMASH,GF_GRAVITY,	TRUE,	TMD_SLOW,		RV(3,1,4,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(0,0,0,0))
RSE(11,	0,				GF_FORCE,	TRUE,	TMD_STUN,		RV(0,1,20,0),	RV(0,0,0,0),	0,		FALSE,	OF_RES_STUN,	RV(30,0,0,0))
RSE(12,	0,				GF_PLASMA,	TRUE,	TMD_STUN,		RV(5,0,0,0),	RV(0,1,75,35),	0,		FALSE,	OF_RES_STUN,	RV(30,0,0,0))
RSE(13,	0,				GF_WATER,	TRUE,	TMD_CONFUSED,	RV(5,1,5,0),	RV(0,0,0,0),	0,		FALSE,	OF_RES_CONFU,	RV(20,0,0,0))
RSE(14,	0,				GF_WATER,	TRUE,	TMD_STUN,		RV(0,1,40,0),	RV(0,0,0,0),	0,		FALSE,	OF_RES_STUN,	RV(0,0,0,0))
RSE(15,	0,				GF_ICE,		TRUE,	TMD_CUT,		RV(0,5,8,0),	RV(0,0,0,0),	0,		FALSE,	OF_RES_SHARD,	RV(0,0,0,0))
RSE(16,	0,				GF_ICE,		TRUE,	TMD_STUN,		RV(0,1,15,0),	RV(0,0,0,0),	0,		FALSE,	OF_RES_STUN,	RV(0,0,0,0))
RSE(17,	RSF_CAUSE_4,	0,			TRUE,	TMD_CUT,		RV(0,10,10,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(0,0,0,0))
RSE(18,	RSF_MIND_BLAST,	0,			TRUE,	TMD_CONFUSED,	RV(3,1,4,0),	RV(0,0,0,0),	0,		FALSE,	OF_RES_CONFU,	RV(0,0,0,0))
...
RSE(27,	0,				GF_NETHER,	FALSE,	S_DRAIN_LIFE,	RV(20,0,2,0),	RV(0,0,0,0),	0,		FALSE,	OF_HOLD_LIFE,	RV(0,0,2000,-1))
RSE(28,	0,				GF_CHAOS,	FALSE,	S_DRAIN_LIFE,	RV(50,0,2,0),	RV(0,0,0,0),	0,		FALSE,	OF_HOLD_LIFE,	RV(0,0,0,0))
...
RSE(34,	RSF_BRAIN_SMASH,0,			TRUE,	TMD_BLIND,		RV(7,1,8,0),	RV(0,0,0,0),	0,		FALSE,	OF_RES_BLIND,	RV(0,0,0,0))
RSE(35,	RSF_BRAIN_SMASH,0,			TRUE,	TMD_CONFUSED,	RV(3,1,4,0),	RV(0,0,0,0),	0,		FALSE,	OF_RES_CONFU,	RV(0,0,0,0))
...
RSE(40,	RSF_SCARE,		0,			TRUE,	TMD_AFRAID,		RV(3,1,4,0),	RV(0,0,0,0),	0,		FALSE,	OF_RES_FEAR,	RV(5,0,0,0))
RSE(41,	RSF_CONF,		0,			TRUE,	TMD_CONFUSED,	RV(3,1,4,0),	RV(0,0,0,0),	0,		FALSE,	OF_RES_CONFU,	RV(10,0,0,0))
RSE(42,	RSF_BLIND,		0,			TRUE,	TMD_BLIND,		RV(11,1,4,0),	RV(0,0,0,0),	0,		FALSE,	OF_RES_BLIND,	RV(10,0,0,0))
