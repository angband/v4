...
EFFECT(BRAWN,          FALSE, 30,	"temporarily boosts your strength")
EFFECT(INTELLECT,      FALSE, 25,	"temporarily boosts your intelligence")
EFFECT(CONTEMPLATION,  FALSE, 25,	"temporarily boosts your wisdom")
EFFECT(NIMBLENESS,     FALSE, 25,	"temporarily boosts your dexterity")
EFFECT(TOUGHNESS,      FALSE, 30,	"temporarily boosts your constitution")
EFFECT(PLEASING,       FALSE,  5,	"temporarily boosts your charisma")
...
EFFECT(ENCHANT_TOHIT,  FALSE, 18,	"attempts to magically enhance a weapon's to-hit bonus. Also gives a chance to break a curse")
EFFECT(ENCHANT_TODAM,  FALSE, 22,	"attempts to magically enhance a weapon's to-dam bonus. Also gives a chance to break a curse")
EFFECT(ENCHANT_WEAPON, FALSE, 25,	"attempts to magically enhance a weapon both to-hit and to-dam. Also gives a chance to break a curse")
EFFECT(ENCHANT_ARMOR,  FALSE, 16,	"attempts to magically enhance a piece of armour. Also gives a chance to break a curse")
EFFECT(ENCHANT_ARMOR2, FALSE, 20,	"attempts to magically enhance a piece of armour with high chance of success. Also gives a chance to break a curse")
...
EFFECT(TRAP_RUNE_SUMMON2, FALSE, 0,	"a rune which summons monsters")
EFFECT(TRAP_RUNE_SUMMON3, FALSE, 0,	"a rune which summons monsters")
EFFECT(TRAP_RUNE_PHASE, FALSE, 0,	"a rune which teleports")
EFFECT(TRAP_RUNE_TELEPORT, FALSE, 0,	"a rune which teleports")
EFFECT(TRAP_RUNE_TELEPORT2, FALSE, 0,	"a rune which teleports")
EFFECT(TRAP_SPOT_FIRE, FALSE,  0,	"a magical fire trap")
EFFECT(TRAP_SPOT_FIRE2, FALSE,  0,	"a magical fire trap")
EFFECT(TRAP_SPOT_FIRE3, FALSE,  0,	"a magical fire trap")
EFFECT(TRAP_SPOT_ACID, FALSE,  0,	"a magical acid trap")
EFFECT(TRAP_SPOT_ACID2, FALSE,  0,	"a magical acid trap")
EFFECT(TRAP_SPOT_ACID3, FALSE,  0,	"a magical acid trap")
...
EFFECT(TRAP_EARTHQUAKE, FALSE, 0, "a trap that triggers an earthquake")
