...
EFFECT(ENCHANT_TOHIT,  FALSE, 18,	"attempts to magically enhance a weapon's to-hit bonus")
EFFECT(ENCHANT_TODAM,  FALSE, 22,	"attempts to magically enhance a weapon's to-dam bonus")
EFFECT(ENCHANT_WEAPON, FALSE, 25,	"attempts to magically enhance a weapon both to-hit and to-dam")
EFFECT(ENCHANT_ARMOR,  FALSE, 16,	"attempts to magically enhance a piece of armour")
EFFECT(ENCHANT_ARMOR2, FALSE, 20,	"attempts to magically enhance a piece of armour with high chance of success")
