...
extern int trap_hide_modifier(int level);
extern void pick_and_place_trap(struct cave *c, int y, int x, int level);
extern void compact_traps();
extern void wipe_trap_list(struct cave *c);
