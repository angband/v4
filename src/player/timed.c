...
static timed_effect effects[] =
{
	...
	{ "You feel a surge of strength!.", "Your strength returns to normal.",
			NULL, NULL,
			0, PU_BONUS, MSG_GENERIC, 0 },
	{ "You feel a surge of intelligence!.", "Your intelligence returns to normal.",
			NULL, NULL,
			0, PU_BONUS, MSG_GENERIC, 0 },
	{ "You feel a surge of wisdom!.", "Your wisdom returns to normal.",
			NULL, NULL,
			0, PU_BONUS, MSG_GENERIC, 0 },
	{ "You feel a surge of dexterity!.", "Your dexterity returns to normal.",
			NULL, NULL,
			0, PU_BONUS, MSG_GENERIC, 0 },
	{ "You feel a surge of constitution!.", "Your constitution returns to normal.",
			NULL, NULL,
			0, PU_BONUS, MSG_GENERIC, 0 },
	{ "You feel a surge of charisma!.", "Your charisma returns to normal.",
			NULL, NULL,
			0, PU_BONUS, MSG_GENERIC, 0 },
};
